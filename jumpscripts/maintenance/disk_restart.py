...
def action(vpool, storagedriver, volume_id):
    ...
    client = src.LocalStorageRouterClient('arakoon://config/ovs/vpools/{vpool}/hosts/{storagedriver}/config?ini=%2Fopt%2FOpenvStorage%2Fconfig%2Farakoon_cacc.ini'.format(vpool=vpool, storagedriver=storagedriver));
